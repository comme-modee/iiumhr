    ...
    return (
        isMainFooter ? (
            <div className={footerStyles.mainFooter} aria-label="회사 정보">
                주소 : 경기도 고양시 일산동구 정발산로24, 3동 512호, 513호 (장항동, 웨스턴타워)｜상호 : 노무법인 이음｜대표자명 : 가희진｜전화번호 : 031-966-9674~5｜팩스번호 : 031-688-8983｜COPYRIGHT (c) 2017 iiumhr.kr.all rights reserved.
            </div>
        ) : (
            <footer className={commonStyles.flexCenter}>
                <div className={footerStyles.info}>
                    <p>
                        주소 : 경기도 고양시 일산동구 정발산로24, 3동 512호, 513호 (장항동, 웨스턴타워)｜상호 :  노무법인 이음｜대표자명 : 가희진<br />
