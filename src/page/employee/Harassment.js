                ...
                <div className={styles.contentContainer}>
                    ...
                    <div className={styles.text}>
                        <div>
                            ...
                            <p className={styles.description}>
                                사용자 또는 근로자가 직장에서의 직급 또는 관계 등의<br />
                                우위를 이용하여 업무상 적정 범위를 넘어<br />
                                다른 근로자에게 신체적, 정신적 고통을 주거나<br />
                                근무 환경을 악화 시키는 행위입니다.
                            </p>
                        </div>
                        <div>
                ...
                <div className={classNames(styles.contentContainer, commonStyles.layout)}>
                    <div className={styles.text}>
                        <div>
                            ...
                            <p className={styles.description}>
                                사업주, 상급자, 동료 등이 다른 근로자에게 성적인<br />
                                언행으로 성적 수치심 또는 혐오감을 느끼게 했을 경우와<br />
                                성적인 요구에 따르지 아니하였다는 이유로<br />
                                근로 환경 및 고용 등에 불이익을 주는 경우입니다.
                            </p>
                        </div>
                        <div>
                            <p className={styles.title}>
                ...
                <div className={styles.contentContainer}>
                    ...
                    <div className={styles.text}>
                        <div>
                            ...
                            <p className={styles.description}>
                                사용자가 비정규직근로자(기간제/단시간/파견근로자)를<br />
                                비교대상근로자(무기계약 근로자/통상근로자/<br />
                                직접고용근로자)에 비하여 임금 그 밖의 근로조건 등에<br />
                                있어서 합리적인 이유 없이 불리하게 처우하는<br />
                                경우 노동위원회에 그 시정을 신청할 수 있습니다.
                            </p>
                        </div>
                        <div>
                            <p className={styles.title}>
